...
export default function Card({ title, id, termCount, link, isPublic }: CardProps) {
  return (
    <Link href={link} passHref>
      <div className="flex flex-col justify-between p-6 border border-gray-300 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white h-[150px] w-[270px] cursor-pointer">
